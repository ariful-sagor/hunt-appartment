...
const HomeDetails = () => {
    ...
    const { title, price, img, bedroom} = useParams();
    ...
    //   const house = rentHouse.find(apartment => apartment._id === _id) || {};
        ...
        <div style={{backgroundColor: '#E5E5E5'}} className="pb-5">
            ...
            <div className="container">
                ...
                <div className="col-md-8">
                      ...
                      {/* <img src={`data:image/png;base64,${img}`} className="img-fluid" alt=""/>  */}
                      ...
                      <div className="row justify-content-between mt-4">
                          ...
                          <div className="pr-3">
                                 <h2 style={{color: '#275A53', fontWeightAbsolute:'bold'}}>${price}</h2>
                          </div>
                      </div>
                     <p className="mt-3">3000 sq-ft., {bedroom} Bedroom, Semi-furnished, Luxurious, South facing Apartment for Rent in Rangs Malancha, Melbourne.</p>
                      ...
                      <div className="mt-4">
                          <h4>Property Details</h4>
                           <p className="mt-3">Address & Area : Rangs Malancha, House-68, Road-6A (Dead End Road), Dhanmondi Residential Area.
                            ...
                            Room Category : {bedroom} Large Bed Rooms with {bedroom} Verandas, Spacious Drawing, Dining & Family Living Room, Highly Decorated Kitchen with Store Room and Servant room with attached Toilet.
